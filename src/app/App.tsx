              ...
              <React.Fragment key={book.id}>
                ...
                {idx < displayBooks.length - 1 && (
                  ...
                  >
                    ...
                    <div style={{ width: 9, height: 70, borderRadius: '1px 1px 0 0', background: '#D0C8B8', flexShrink: 0, transform: 'rotate(-30deg)', transformOrigin: 'bottom center', marginLeft: 32 }} />
                  </div>
                )}
              </React.Fragment>
            );
